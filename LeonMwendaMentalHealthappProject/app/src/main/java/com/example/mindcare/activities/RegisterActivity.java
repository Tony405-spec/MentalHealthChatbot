...
public class RegisterActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.authTitle)).setText("Create account");
        ((TextView) findViewById(R.id.authSubtitle)).setText("Start a calmer daily check-in ritual.");
        ...
        secondaryButton.setText("I already have an account");
        
        // Default remember me to true for new registrations for better UX
        rememberCheck.setChecked(true);

        primaryButton.setOnClickListener(v -> register());
    ...
    private void register() {
        ...
        setLoading(true);
        auth.register(email, password).addOnSuccessListener(result -> {
